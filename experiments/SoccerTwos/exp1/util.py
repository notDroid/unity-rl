'''
This file adapts the old mlagents.envs petting zoo wrappers to work with the updated petting zoo.
1. Uses gymansium instead of gym (for spaces)
2. Petting Zoo Parallel Environment Wrapper
'''

'''
MODIFIED IMPORT
mlagent_envs.envs.unity_pettingzoo_base_env.py copy pasted from: 
https://github.com/Unity-Technologies/ml-agents/blob/main/ml-agents-envs/mlagents_envs/envs/unity_pettingzoo_base_env.py
'''

import atexit
from typing import Optional, List, Set, Dict, Any, Tuple
import numpy as np
from gymnasium import error, spaces # MODIFIED
...
'''
MODIFIED IMPORT AND IMPLEMENTATION
mlagent_envs.envs.unity_parallel_env.py copy pasted from: 
https://github.com/Unity-Technologies/ml-agents/blob/main/ml-agents-envs/mlagents_envs/envs/unity_parallel_env.py
'''

from typing import Optional, Dict, Any, Tuple
from gymnasium import error # MODIFIED
from mlagents_envs.base_env import BaseEnv
from pettingzoo import ParallelEnv

# from mlagents_envs.envs.unity_pettingzoo_base_env import UnityPettingzooBaseEnv   # MODIFIED VERSION IN THIS FILE
